...
import { LayoutDashboard, Package, ShoppingBag, Settings, LogOut, Menu, X, Tag, BarChart3, Newspaper, Mail, Rocket, Layers, PackagePlus, FileText, Building2 } from 'lucide-react';
